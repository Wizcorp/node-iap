...
function parseResult(resultString) {
	...
	result.expirationDate = new Date(parseInt(resultObject.expirationDate.substr(6), 10)).getTime();
	result.originalPurchaseDate = new Date(parseInt(resultObject.originalPurchaseDate.substr(6), 10)).getTime();
	result.purchaseDate = new Date(parseInt(resultObject.purchaseDate.substr(6), 10)).getTime();
