...
const apiUrl = {
	...
	sandbox: 'https://appstore-sdk.amazon.com/sandbox/version/1.0/verifyReceiptId/developer/'
};
...
exports.verifyPayment = function (payment, cb) {
	...
	const requestUrl = `${url + payment.secret}/user/${payment.userId}/receiptId/${payment.receipt}`;
