...
function parseResult(result) {
	...
	return {
		...
		transactionId: getReceiptFieldValue(receipt, 'transaction_id'),
		productId: getReceiptFieldValue(receipt, 'product_id')
...
exports.verifyPayment = function (payment, cb) {
	...
	function checkReceipt(error, result, environment) {
		...
		if (payment.hasOwnProperty('productId') && payment.productId !== getReceiptFieldValue(receipt, 'product_id')) {
